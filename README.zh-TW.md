...
- **圖庫刪除**：圖片庫／曲庫刪除後不會被 P2P 再傳回來；重新匯入同一檔可還原。
- **角色卡**：未勾選的勾選欄仍顯示選項；編輯 MODE 更緊湊；筆記欄可拉高並記住高度。
- **ZIP／資料夾**：打包音訊／影片以雜湊檔名還原。

詳見 [`docs/changelog-2026-09-mid.md`](docs/changelog-2026-09-mid.md) 或站內聊天「更新日誌」。
